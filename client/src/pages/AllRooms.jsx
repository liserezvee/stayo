    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div>
        <div className="flex flex-col items-start text-left">
          <h1 className="from-neutral-800 text-4xl md:text-[40px]">
            Hotel Rooms
          </h1>
          ...
          >
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <p
                ...
                className="text-gray-800 text-3xl font-sans cursor-pointer"
              >
                {room.hotel.name}
              </p>
      ...
      {/* right -- filters */}
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16 ml-4">
        <div
